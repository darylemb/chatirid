...
def Send_Lista_Clientes(clientList):
	...
	for i in range(6):
		print(clientList[i])
		clientSocket.send(bytes(str(clientList[i]),"utf-8"))
...
def Lista():
	...
	opc5=c5.get()
	opc6=c6.get()
	print("la opc1 es :",opc1)
	print("la opc2 es :",opc2)
	print("la opc3 es :",opc3)
	print("la opc4 es :",opc4)
	print("la opc5 es :",opc5)
	print("la opc6 es :",opc6)
...
##################################***************************************************##########################################
	...
	print(clientList[5])
	print(clientList)
	#messagebox.showinfo(title="Los elegidos son: ",message=clientList)
